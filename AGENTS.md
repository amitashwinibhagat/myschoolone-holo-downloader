...
- Preserve the portal automation's read-only behavior: no message sending, form submission, acknowledgement, setting changes, or content deletion, and never bypass authentication or CAPTCHA.
